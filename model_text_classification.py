...
class Model_Text_Classification:
    def __init__(self, train_dataset:Dataset, valid_dataset: Dataset, labId:str = "video_reactionary_detection", model_name:str = 'google-bert/bert-base-multilingual-uncased'):
        """
        Parameters
        ----------
